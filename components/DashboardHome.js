  ...
  return (
    <div className="h-full">
      ...
      <div className="mx-4 grid grid-cols-4 gap-4">
        <div className="p-8 m-4 text-2xl text-indigo-800 bg-white border border-gray-200 shadow-lg rounded flex justify-center items-center">
          <FontAwesomeIcon icon={faShoppingBasket} />
          <p className="ml-4 text-lg"> {orders.length} Orders </p>
        </div>
        <div className="p-4 m-4 text-2xl text-indigo-800 bg-white border border-gray-200 shadow-lg rounded flex justify-center items-center">
