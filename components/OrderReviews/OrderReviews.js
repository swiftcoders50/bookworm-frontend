					...
					<div className="md:grid md:grid-cols-5">
						...
						<div className="md:col-span-2 px-3 md:px-16">
							<div className="bg-white shadow-lg rounded-lg border p-12">
								<div className="flex justify-between mb-2 text-lg font-medium text-center text-gray-800">
									<span>Subtotal:</span>
				...
				<div className="px-3 py-24 md:p-32">
					<div className="w-4/5 mx-auto">
						<div className="text-center">
							<h3 className="p-3 md:p-5 md:mx-32 rounded-full bg-indigo-200 text-yellow-600 font-medium">
								Your Cart is Empty!
							</h3>
						</div>
					</div>
