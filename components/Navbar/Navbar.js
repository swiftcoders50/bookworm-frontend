        ...
        <nav className="flex items-center bg-gray-200 p-3 flex-wrap lg:px-20 ">
          ...
          >
            <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start flex flex-col lg:h-auto">
              ...
              <a
                href="#"
                className="lg:inline-flex lg:w-auto w-full px-5 py-2 rounded text-gray-600 font-bold items-center justify-center hover:hover:bg-red-500 hover:text-white"
              >
                <div className="flex">
