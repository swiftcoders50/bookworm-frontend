	...
	return (
		<div className="bg-gray-100">
			...
			<div className="mx-3 py-8">
				<div className="max-w-screen-xl mx-auto bg-white shadow-md border-t-4 border-green-400  p-4 sm:p-8 rounded-md">
					<div className="border-b-2">
						<h1 className="text-2xl sm:text-3xl font-semibold color-indigo-900 text-gray-900">
							My Account
						</h1>
