...
const checkOut = () => {
	const [cartData, setCardData, cartTotal, setCartTotal] =
						...
						<div className="grid md:grid-cols-2 gap-12">
							<div>
								<div className="p-3 bg-gray-100 rounded-full my-3">
									<h1 class="ml-2 font-semibold text-teal-600 uppercase">
							...
							<div>
								...
								<div className="">
									<h5 className="flex justify-between lg:px-4 m-1 text-lg font-medium text-center text-gray-800">
									...
									<hr />
									<h5 className="flex justify-between lg:px-4 m-1 text-lg font-medium text-center text-gray-800">
										<span>Total:</span> <span>$ {cartTotal + 50}</span>
									</h5>
									<hr />
								</div>
								<button className="flex justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase bg-teal-500 rounded-full shadow item-center bg-indigo-900 hover:bg-teal-700 focus:shadow-outline focus:outline-none">
									<input
										className="ml-2 bg-indigo-900 font-semibold text-gray-200 uppercase cursor-pointer"
										value="Confirm Order"
										type="submit"
									/>
								</button>
